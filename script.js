...
(() => {
  ...
  class Visual3D {
    ...
    async _loadModels() {
      ...
      if (this.models.bot) this._applyMaterialFixups(this.models.bot, 0x3b82f6, false);
      ...
      if (this.models.ship) this._applyMaterialFixups(this.models.ship, 0xf87171, false);
      if (this.models.boat) this._applyMaterialFixups(this.models.boat, 0x8b5a2b, false);
      ...
      if (this.models.port) {
          ...
          this._applyMaterialFixups(p, 0xe2e8f0, false); // Light Gray/White
      ...
      if (this.models.factory) {
          ...
          this._applyMaterialFixups(f, 0xe6d5b8, false); // Light brown + light white
      ...
      if (this.models.truck) {
          const t = this._buildInstance(this.models.truck, 30, 0x333333, false); // Light black
      ...
      if (this.models.ship) {
        for (let i = 0; i < 7; i++) {
          ...
          const shipPivot = this._buildInstance(this.models.ship, 45, 0xf87171, false);
    ...
    _makeBotObject() {
      const group = new THREE.Group();
      if (this.models.bot) {
        group.add(this._buildInstance(this.models.bot, 36, 0x3b82f6, false));
      } else {
    ...
    sync(game, alpha) {
      ...
      while (this.boatObjects.length < game.deliveries.length) {
        const pivot = new THREE.Group();
        const m = this.models.boat ? this._buildInstance(this.models.boat, 25, 0x8b5a2b, false) : new THREE.Mesh(new THREE.BoxGeometry(20, 10, 30), new THREE.MeshStandardMaterial({color:0x8b5a2b}));
        pivot.add(m);
    ...
    update(dt) {
      ...
      if (this.goodsUnlocked) {
          ...
          if (this.truck.state === "IDLE") {
              ...
              const target = { x: this.port.x - 80, y: this.port.y };
              if (dist(this.truck, target) < 5) {
                  if (this.truck.type === "wood") this.portStorage.goodsWood += this.truck.load;
                  else this.portStorage.goodsStone += this.truck.load;
                  this.truck.load = 0;
